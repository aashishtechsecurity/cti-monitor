...
export class CtiMap {
    ...
    `;
        const mapInner = container.querySelector('#map-inner-container');
    ...
    async renderThreatLayers(threats) {
        if (!this.deck)
            return;
        ...
        layers.push(new ScatterplotLayer({
            ...
            getRadius: (d) => (d.severity === 'critical' ? 80000 : 50000),
            radiusMinPixels: 6,
            radiusMaxPixels: 14,
            pickable: true,
        }));
