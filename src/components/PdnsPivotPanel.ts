...
export const PDNS_SAMPLE_RECORDS: PdnsRecord[] = [
  {
...
export class PdnsPivotPanel {
  ...
  private currentQuery: string = '185.220.101.5';
  ...
  public render(): void {
    ...
    const input = container.querySelector('#pdns-input') as HTMLInputElement;
    if (input) {
