export interface AchHypothesis {
  ...
  primaryTtp: string;
  verdict: 'HIGH CONFIDENCE ATTRIBUTION' | 'MODERATE CONFIDENCE' | 'POSSIBLE FALSE-FLAG';
}

export const ACH_EVALUATIONS: AchHypothesis[] = [
  {
      ...
      <div class="panel-body">
        ...
        <div style="display: flex; flex-direction: column; gap: 8px;">
          ${ACH_EVALUATIONS.map((h) => {
            ...
            if (h.verdict === 'MODERATE CONFIDENCE') color = '#eab308';
            else if (h.verdict === 'POSSIBLE FALSE-FLAG') color = 'var(--accent-red)';
