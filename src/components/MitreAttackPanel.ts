export interface TtpTechnique {
  id: string;
  name: string;
  tactic: 'Initial Access' | 'Execution' | 'Persistence' | 'Defense Evasion' | 'Credential Access' | 'Impact';
  description: string;
  observedGroups: string[];
}

export const MITRE_TECHNIQUES: TtpTechnique[] = [
  {
    id: 'T1190',
...
export class MitreAttackPanel {
  ...
  private selectedTechnique: TtpTechnique | null = null;
